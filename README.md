...
- **智能列表**：平铺视图顶部：全部音乐 / 我的喜爱 / 最常听 / 最近播放 / 最近添加 / 专辑 / 艺术家（各取前 100）
...
- **沉浸式播放页（⤢）**：封面模糊背景 + 大封面 + 音质行；大歌词栏逐字卡拉OK，点击歌词行跳转；☰ 待播清单/历史记录（最近 50 首）；⤡ 退出
...
- **听歌报告**：设置 → 曲库工具：Top 歌曲/艺术家/专辑、累计收听时长、最爱时段；「复制报告」发文本、「生成分享图」直接粘贴图片发群；数据仅存本机，可一键清空
